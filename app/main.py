...
app.add_middleware(CORSMiddleware, allow_origins=["*", "https://miba-ui-340635219170.europe-west1.run.app", "https://miba-mobile-340635219170.europe-west1.run.app"], allow_methods=["*"], allow_headers=["*"])
